...
*/
function getDataHolder(data, name) {
	var r = '<div class="Data">';
	r += '<div class="DataElement">' + name+': <font color="' + ((data.updateTime > data.invalidateTime) ? 'green' : 'red') + '">'+((typeof(data.value) !== 'undefined' && data.value != null)?data.value.toString():'None')+'</font>' + ' (' + getUpdated(data) + ')</div>';
